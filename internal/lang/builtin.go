...
var builtin = []Language{
	...
	{Name: "Bazel", Extensions: []string{"bzl"}, Filenames: []string{"BUILD", "BUILD.bazel", "MODULE.bazel", "WORKSPACE", "WORKSPACE.bazel"}, LineComments: []string{"#"}, Quotes: dqsq, MultiQuotes: [][2]string{{`"""`, `"""`}, {`'''`, `'''`}}},
	{Name: "Batch", Extensions: []string{"bat", "cmd"}, LineComments: []string{"::", "REM ", "rem ", "@REM ", "@rem "}},
	{Name: "C", Extensions: []string{"c", "h", "inc"}, LineComments: []string{"//"}, BlockComments: cComments, Quotes: dqsq},
	{Name: "C#", Extensions: []string{"cs", "csx"}, LineComments: []string{"//"}, BlockComments: cComments, Quotes: dq},
	{Name: "C++", Extensions: []string{"cpp", "cc", "cxx", "hpp", "hh", "hxx", "ipp", "inl", "ino"}, LineComments: []string{"//"}, BlockComments: cComments, Quotes: dqsq},
	...
	{Name: "UnrealScript", Extensions: []string{"uc"}, LineComments: []string{"//"}, BlockComments: cComments, Quotes: dqsq},
